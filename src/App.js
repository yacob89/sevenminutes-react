    ...
    return (
      <div>
                ...
                <Table.Cell>
                  <Header as="h4" image>
                    <Image
                      rounded
                      size="mini"
                      src="https://mapid.io/images/mapid-logo-47.webp"
                    />
                    <Header.Content>
                      Lena
        ...
        <Container>
          <Menu stackable>
            <Menu.Item>
              <img alt="logo" src="https://mapid.io/images/mapid-logo-47.webp" />
            </Menu.Item>
        ...
        <Container>
          <Item.Group divided>
            <Item>
              <Item.Image src="https://mapid.io/images/mapid-logo-47.webp" />
              <Item.Content>
