        ...
        <Grid.Row>
          <Grid.Column width={12}>
            ...
            <p style={{ fontSize: "1.33em" }}>
              ...
              Cor.12:3; Rom. 8:6; 10:12-13 (1/2 Minute)
            </p>
            <Header as="h3" style={{ fontSize: "2em" }}>
              2. Praying
            </Header>
            <p style={{ fontSize: "1.33em" }}>
              ...
              Telling Him that we love Him – 2 Cor. 3:16; Psa. 62:8 (1 Minute)
            </p>
            <Header as="h3" style={{ fontSize: "2em" }}>
              3. Pray-reading
            </Header>
            <p style={{ fontSize: "1.33em" }}>
              ...
              the verses into a personal prayer – Eph. 6:17-18; 2 Tim. 3:16 (2
              1/2 Minutes)
            </p>
            <Header as="h3" style={{ fontSize: "2em" }}>
              4. Confession
            ...
            <p style={{ fontSize: "1.33em" }}>
              ...
              all blockages to fellowship. Asking for forgiveness and cleansing
              – 1 John 1:7, 9; Psa. 66:18; Isa. 59:1-2 (1 Minute)
            </p>
            <Header as="h3" style={{ fontSize: "2em" }}>
              5. Consecration
            </Header>
            ...
            <p style={{ fontSize: "1.33em" }}>
              Giving thanks for all things; for all the persons, situations and
              things in your life and praising Him – Eph. 5:20; 1 Thes. 5:18
              (1/2 Minute)
            </p>
            <Header as="h3" style={{ fontSize: "2em" }}>
              7. Petition
            ...
            <p style={{ fontSize: "1.33em" }}>
              ...
              – 1 Tim. 2:1: Eph. 6:18; Matt. 7:7; Psa. 143:8 (1 Minute)
            </p>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
